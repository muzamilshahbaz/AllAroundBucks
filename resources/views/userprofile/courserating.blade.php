...
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
@elseif ($course->rating == '0.1')
<i class="fa fa-star-half-o" style="color: orange"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
@elseif ($course->rating == '0.2')
<i class="fa fa-star-half-o" style="color: orange"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
@elseif ($course->rating == '0.3')
<i class="fa fa-star-half-o" style="color: orange"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
@elseif ($course->rating == '0.4')
<i class="fa fa-star-half-o" style="color: orange"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
...
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
@elseif ($course->rating == '0.6')
<i class="fa fa-star-half-o" style="color: orange"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
@elseif ($course->rating == '0.7')
<i class="fa fa-star-half-o" style="color: orange"></i>
<i class="fa fa-star-half-o"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
@elseif ($course->rating == '0.8')
<i class="fa fa-star" style="color: orange"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
@elseif ($course->rating == '0.9')
<i class="fa fa-star" style="color: orange"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
...
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
@elseif ($course->rating == '1.1')
<i class="fa fa-star" style="color: orange"></i>
<i class="fa fa-star-half-o" style="color: orange"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
@elseif ($course->rating == '1.2')
<i class="fa fa-star" style="color: orange"></i>
<i class="fa fa-star-half-o" style="color: orange"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
@elseif ($course->rating == '1.3')
<i class="fa fa-star" style="color: orange"></i>
<i class="fa fa-star-half-o" style="color: orange"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
@elseif ($course->rating == '1.4')
<i class="fa fa-star" style="color: orange"></i>
<i class="fa fa-star-half-o" style="color: orange"></i>
<i class="fa fa-star-o"></i>
<i class="fa fa-star-o"></i>
