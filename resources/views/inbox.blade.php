        ...
        <div class="card" style="padding: 5px; border-radius:0.5em; border: 1px solid #5298D2">
            <div class="row g-0">
                ...
                <div class="col-12 col-lg-7 col-xl-9">
                    ...
                    <div class="flex-grow-0 py-3 px-4 border-top mb-0 mr-3" style="background-color: #5298D2;border-radius:0.6em">
                        <div class="input-group">
                            <input type="text" class="form-control mr-3" placeholder="Type your message" style="border-radius:2em">
