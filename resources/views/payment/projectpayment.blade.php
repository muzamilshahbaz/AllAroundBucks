    ...
    <div class="card" style="padding: 5px; border-radius:0.5em; border:none;">
        <div class="card-body">
            <div class="card-title">
                <h4>Payment for the <b style="color: #5298D2"><i>"{{ $project->project_title }}"</i></b> Project</h4>
            </div>
            <br>
            ...
            <div class="signup-form" style="width:55%">
                <form
                role="form"
                action="/acceptAndPay/{{ $proposal->proposal_id }}"
                method="POST"
            ...
            <div class="col-4">
                <div class='form-group cvc required'>
                    <label class='control-label'>CVC</label> <input autocomplete='off'
                        class='form-control card-cvc' placeholder='3 or 4 digits, ex. 311' maxlength="4" size='4'
                        type='text' onkeypress='validate(event)'>
                </div>
            </div>
               <div class="col-4">
                <div class='form-group expiration required'>
                    <label class='control-label'>Expiration Month</label> <input
                        ...
                        type='text' onkeypress='validate(event)'  maxlength="2">
                </div>
               </div>
              <div class="col-4">
                <div class='form-group expiration required'>
